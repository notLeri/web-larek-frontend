...
export class Basket extends Component<IBasket> {
    ...
    constructor(
        ...
        this._basketSubmitButton = ensureElement<HTMLButtonElement>(`.basket__button`, container);
        this._basketPriceElement = ensureElement<HTMLSpanElement>(`.basket__price`, container);
